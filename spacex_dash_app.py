...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard with maryam-asadi-coder',
                                        style={'textAlign': 'center', 'color': '#00478A',
                                               'font-size': 40}),
...
def get_pie_chart(entered_site):
    ...
    custom_colors = ['#87CEEB', '#6495ED', '#4682B4', '#2964A0', '#00478A']
    if entered_site == 'ALL':
